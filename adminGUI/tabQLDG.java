...
public class tabQLDG extends JFrame {
	
	static private Connection conn,conn2,conn3,conn4,conn5,conn6,connxoapass,connpass;
	...
	static private void AddThemEvent()
	{
		...
		btn1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "INSERT INTO Docgia (ID_Docgia,Ten_Docgia,Ngaysinh_Docgia,Khoa_Docgia ,NCap_Docgia) VALUES(?,?,?,?,?)";
				String sqlpass = "INSERT INTO Docgia_Pass (ID_Docgia,Pass_Docgia) VALUES(?,?)";
				try{
					...
					stmtpass.setString(2,tID.getText()); // Luc dau Pass = ID
		...
		btn2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sqlxoapass = "DELETE FROM Docgia_Pass WHERE ID_Docgia = ?"; 
				try{
		...
		btn3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//String sql = "INSERT INTO Docgia (ID_Docgia,Ten_Docgia,Ngaysinh_Docgia,Khoa_Docgia,NCap_Docgia) VALUES(?,?,?,?,?)";
				String sql1 = "UPDATE Docgia SET Ten_Docgia = ?,Ngaysinh_Docgia = ?,Khoa_Docgia = ?,NCap_Docgia = ? WHERE ID_Docgia = ?";
				try{ // chua Update ID
					stmt3 = conn3.prepareStatement(sql1);
					//stmt.setString(1,tID.getText());
					stmt3.setString(1,tName.getText());
					stmt3.setString(2,tBirth.getText());
					stmt3.setString(3,tKhoa.getText());
					...
					dt.setValueAt(tKhoa.getText(),ii,3);
	...
	static JPanel addControls(){
		...
		p3.setBorder(btt1);
		lTit = new JLabel("QUẢN LÝ ĐỌC GIẢ");
		...
		btn1 = new JButton("Thêm đọc giả",addIma);
		btn2 = new JButton("  Xóa đọc giả 	",delIma);
